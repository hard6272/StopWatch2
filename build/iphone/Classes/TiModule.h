...
/**
 The base class for all StopWatch2 modules
 */
...
/**
 StopWatch2 Platform calls this method on startup.
 */
-(void)startup;

/**
 StopWatch2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 StopWatch2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 StopWatch2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 StopWatch2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
