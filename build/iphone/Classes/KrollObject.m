...
//@interface StopWatch2Object : NSObject
//@end

@interface StopWatch2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StopWatch2Object class]])
		{
			for (NSString *key in [[(StopWatch2Object*)o modules] allKeys])
			{
