...
// in simulator we redefine to format for StopWatch2 Developer console
...
{\
	NSString * exceptionName = [@"org.stopwatch2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stopwatch2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIStopWatch2NativeItemNone = -1, 
	UIStopWatch2NativeItemSpinner = -2,
	UIStopWatch2NativeItemProgressBar = -3,
	
	UIStopWatch2NativeItemSlider = -4,
	UIStopWatch2NativeItemSwitch = -5,
	UIStopWatch2NativeItemMultiButton = -6,
	UIStopWatch2NativeItemSegmented = -7,
	
	UIStopWatch2NativeItemTextView = -8,
	UIStopWatch2NativeItemTextField = -9,
	UIStopWatch2NativeItemSearchBar = -10,
	
	UIStopWatch2NativeItemPicker = -11,
	UIStopWatch2NativeItemDatePicker = -12,
	
	UIStopWatch2NativeItemInfoLight = -13,
	UIStopWatch2NativeItemInfoDark = -14,
	
	UIStopWatch2NativeItemDisclosure = -15,
	
	UIStopWatch2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all StopWatch2 instances of
