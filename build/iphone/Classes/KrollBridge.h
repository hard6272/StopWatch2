...
@interface StopWatch2Object : KrollCoverageObject {
#else
@interface StopWatch2Object : KrollObject {
#endif
@private
...
extern NSString * StopWatch2$ModuleRequireFormat;
