...
/**
 Base class for all StopWatch2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the StopWatch2 view hierarchy (such as wrapped iOS UIViews) was touched.
